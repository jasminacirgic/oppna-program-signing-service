  ...
  <form method="post" action="https://localhost:9443/ss/sign/prepare">
    <fieldset>   
      <ul>
        ...
        <li>
          <input type="radio" name="submitUri" id="submitUri_http" value="http://localhost:7080/appx/appx/saveSignature" class="radio"/>
          <label for="submitUri_http">http</label>
          <input type="radio" name="submitUri" id="submitUri_http" value="https://localhost:7443/appx/appx/saveSignature" checked="checked" class="radio"/>
